...
namespace RetroGamingAPI.Controllers.Account
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Login(LoginUsernameViewModel login)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> RegisterAsync(RegistrationModel registerData)
        {
            if (ModelState.IsValid)
            {
